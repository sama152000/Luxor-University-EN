...
export class VisionMissionService {
  ...
  getHistory(): string {
    return `Luxor University was established in 2019 as the first government university in the city of Luxor, named after the historic city that contains a third of the world's antiquities. The university aims to be a center of knowledge that bridges the rich past and the promising future.`;
  }
}
